...
<html lang="en">
  ...
  <hr>
   ...
   <ul class="nav nav-pills flex-column mb-auto">
    ...
    <li>
      <a href="addProduct.php" class="nav-link text-white active">
        <!-- <svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"></use></svg> -->
                ...
                <div class="card-body">
                      <form action="../controller/product.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" rows="4" class="form-control" id="description" name="description" placeholder="" required></textarea>
                        </div>
                        <br>
                        <div class="form-group">
