 ...
 <div class="row" style="width: 100%;">
  ...
  <hr>
   ...
   <ul class="nav nav-pills flex-column mb-auto">
    ...
    <li>
      <a href="editProduct.php" class="nav-link text-white active">
        <!-- <svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"></use></svg> -->
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-justify" viewBox="0 0 16 16">
        <path fill-rule="evenodd" d="M2 12.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5z"/>
      </svg>
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <?php
                    ...
                    $str_data = file_get_contents("http://localhost/diamond/api/product/view");
                    ...
                    foreach ($data as $product) {
                      echo '
                        <tbody>
                          ...
                          <td><button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#editModal'.$product['id'].'">Edit</button></td>
                          <td><button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal'.$product['id'].'">Delete</button></td>
                          </tr>
