                ...
                <div class="card-body">
                    <form action="../controller/blog.php" method="POST" id='addBlog' enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="12"  type="text" class="form-control" id="description" name="description" placeholder="" required></textarea>
                        </div>
                        <br>
                        <div class="form-group">
                        ...
                        <br>
                        <button type="submit" class="btn btn-success" id="addBlog" name="addBlog">Add Blog</button>
                    </form>
                </div>  
            </div>
      </div>
