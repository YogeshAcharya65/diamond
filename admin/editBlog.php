 ...
 <div class="row" style="width: 100%;">
  ...
  <hr>
   ...
   <ul class="nav nav-pills flex-column mb-auto">
    ...
    <li>
      <a href="editBlog.php" class="nav-link text-white active">
          ...
          <div class="card">
              ...
              <div class="card-body">
                <?php
                    ...
                    $str_data = file_get_contents("http://localhost/diamond/api/blog/all");
                    ...
                    foreach ($data as $blog) {
                      echo '
                        ...
                        <tr>
                          ...
                          <td><button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#editBlog'.$blog['id'].'">Edit</button></td>
                          <td><button type="button" class="btn btn-danger btn-sm"  data-bs-toggle="modal" data-bs-target="#deleteBlog'.$blog['id'].'">Delete</button></td>
                        </tr>
