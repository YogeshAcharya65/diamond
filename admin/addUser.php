...
<html lang="en">
  ...
  <hr>
   ...
   <ul class="nav nav-pills flex-column mb-auto">
    ...
    <li>
      <a href="addUser.php" class="nav-link text-white active">
   ...
   <div class="col-md-8">
        ...
        <div class="card">
                ...
                <div class="card-body">
                    <form action="../controller/registerMember.php" method="POST">
                        <div class="form-row">
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <input type="email" class="form-control" id="email" name="username" placeholder="name@fitness.com" required>
                        </div>
                        <div class="form-group col-md-8">
