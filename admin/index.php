...
<div class="row" style="width: 100%;">
  ...
  <hr>
   ...
   <ul class="nav nav-pills flex-column mb-auto">
    ...
    <li>
      <a href="viewUser.php" class="nav-link text-white">
          ...
          <div class="card">
              ...
              <div class="card-body">
                <?php
                    ...
                    $str_data = file_get_contents("http://localhost/diamond/api/contact/all");
                    ...
                    foreach ($data as $contact) {
                      echo '
                        ...
                        <tr>
                          ...
                          <td><button type="button" class="btn btn-danger btn-sm"  data-bs-toggle="modal" data-bs-target="#deleteBlog'.$contact['id'].'">Delete</button></td>
                        </tr>


                        <div class="modal fade" id="deleteBlog'.$contact['id'].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              Do you want to remove <span class="text-danger"> '.$contact['name'].' </span>
                            </div>
                            <div class="modal-footer">
                            <form action="../controller/queryRemove.php"  method="POST">
                              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                              <input type="hidden" name="delete_id" value="'.$contact['id'].'">
                               <button type="submit" class="btn btn-danger" name="deleteQuery" value="deleteQuery">Delete Query</button>
                              </form>
                            </div>
                          </div>
                        </div>
